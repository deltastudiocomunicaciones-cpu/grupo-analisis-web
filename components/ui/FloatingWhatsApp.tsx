...
export default function FloatingWhatsApp() {
  ...
  let message =
    "Hola Grupo A&C. Visité su página web y quiero recibir orientación sobre sus servicios. Origen: web Grupo A&C.";
  ...
  if (
    pathname === "/soluciones/devolucion-impuestos" ||
    pathname === "/soluciones/devolucion-impuestos/"
  ) {
    message =
      "Hola Grupo A&C. Visité la página de Devolución de Impuestos y quiero evaluar si mi empresa puede solicitar un saldo a favor ante la DIAN. Origen: web / devolución de impuestos.";
  }
