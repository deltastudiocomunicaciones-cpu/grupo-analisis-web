...
export default function Loader() {
  ...
  useEffect(() => {
    const hasSeenIntro = sessionStorage.getItem("grupoayc_intro_seen");
    ...
    sessionStorage.setItem("grupoayc_intro_seen", "true");
  }, []);
      ...
      {loading && (
        ...
        >
          ...
          <motion.div
            ...
            className="absolute left-1/2 top-1/2 h-[220px] w-[360px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#c96a1b]/20 blur-[90px] md:h-[280px] md:w-[720px] md:blur-[120px]"
          />
